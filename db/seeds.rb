...
a2 = Animal.create!(breed: "mix", description: "Taking swift action, Patiala police on Wednesday evening arrested a youngster for killing a stray dog with a gun in Patran.", image_url: "https://img.republicworld.com/republic-prod/stories/promolarge/xhdpi/r869mdwthwq5zriq_1620365874.jpeg?tr=w-1200,h-900", age: " 3 years", sex: "male", species: "dog", adopter_id: u6.id, admin_id: u2.id, name: "bunny")

a3 = Animal.create!(breed: "mix", description: "Before you get a dog, you can't quite imagine what living with one might be like; afterward, you cant imagine living any other way.", image_url: "https://www.azquotes.com/image-quotes/Quotation-Johnny-Depp-The-only-creatures-that-are-evolved-enough-to-convey-pure-7-64-02.jpg", age: "47 months", sex: "male", species: "dog", adopter_id: u7.id, admin_id: u3.id, name: "simba")

a4 = Animal.create!(breed: "mix", description: "Such short little lives our pets have to spend with us, and they spend most of it waiting for us to come home each day.”", image_url: "https://i.ytimg.com/vi/ze4w1xrm8UI/maxresdefault.jpg", age: " 18 months", sex: "female", species: "dog", adopter_id: u6.id, admin_id: u2.id, name: "bruzo")

a5 = Animal.create!(breed: "mix", description: "Dogs never talk about themselves but listen to you while you talk about yourself, and keep up an appearance of being interested in the conversation.", image_url: "https://www.thesprucepets.com/thmb/W5BpZok9D4ORGN7Ept5LEOssCvo=/2119x1414/filters:no_upscale():max_bytes(150000):strip_icc()/FrenchBulldogGettyKurtPas1-bd2d994356154273b05c9ca57d21523e.jpg", age: "14 months", sex: "male", species: "dog", adopter_id: u7.id, admin_id: u1.id, name: "lolo")

a6 = Animal.create!(breed: "mix", description: "I believe cats to be spirits come to earth. A cat, I am sure, could walk on a cloud without coming through", image_url: "https://media.kidadl.com/600f8528b0c66b5e2a888303-animal-shelters-are-sometimes-compelled-to-put-the-strays-down-largely-due-to-lack-of-space.jpeg.webp", age: "4 year", sex: "female", species: "cat", adopter_id: u7.id, admin_id: u2.id, name: "navy")

a7 = Animal.create!(breed: "mix", description: "Every stray deserves a chance at love, a home and a warm bed to sleep at night", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQywn9xcNx_W6Swzf6B7i1_sj6d9cNUCPztUQ&usqp=CAU", age: "3 years", sex: "female", species: "cow", adopter_id: u7.id, admin_id: u3.id, name: "patty")
